...
QT_MOC_LITERAL(1, 14, 15), // "seriOpen_signal"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 16), // "saveSubmitSignal"
QT_MOC_LITERAL(4, 48, 6), // "isSave"
QT_MOC_LITERAL(5, 55, 9), // "circleNum"
QT_MOC_LITERAL(6, 65, 11), // "radiusMeter"
QT_MOC_LITERAL(7, 77, 18) // "on_btnOpen_clicked"

    },
    "settingDialog\0seriOpen_signal\0\0"
    "saveSubmitSignal\0isSave\0circleNum\0"
    "radiusMeter\0on_btnOpen_clicked"
};
...
void settingDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->seriOpen_signal((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->saveSubmitSignal((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (settingDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&settingDialog::seriOpen_signal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (settingDialog::*_t)(bool , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&settingDialog::saveSubmitSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void settingDialog::seriOpen_signal(bool _t1)
{
...
// SIGNAL 1
void settingDialog::saveSubmitSignal(bool _t1, int _t2, int _t3)
{
